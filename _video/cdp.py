...
TITLE = "ToneWise — Practice Mandarin tones with an AI that grades you live | H0 Hackathon"
DESC = (
    "ToneWise lets you practice real Mandarin conversations with Lin Wei, an AI native "
    "speaker, and grades your tones and grammar after every reply — then builds a "
    "spaced-repetition queue from your actual mistakes.\n\n"
    "Live: " + LIVE_URL + "\n"
    "Code: " + REPO_URL + "\n\n"
    "Stack: Vercel + Next.js 16 + AWS DynamoDB (single-table design + GSI) + Google "
    "Vertex AI (Gemini 2.5 Flash, keyless service-account OAuth). Built for the H0: Hack "
